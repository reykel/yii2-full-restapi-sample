...
class AccessToken extends ActiveRecord
{
    ...
    public static function generateAuthKey($user)
    {
        ...
        $accessToken->consumer = isset($user->consumer) ? $user->consumer : $accessToken->defaultConsumer;
        $accessToken->access_given = isset($user->access_given) ?  $user->access_given : $accessToken->defaultAccessGiven;
